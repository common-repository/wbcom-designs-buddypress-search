		...
		<div class="item">
			<?php if ( bp_activity_has_content() ) : ?>
				<div class="item-title">
					<?php echo esc_html( buddypress_search_activity_intro( 30 ) ); ?>
				</div>
			<?php endif; ?>
			<div class="item-meta activity-header">
				<strong class="activity-user">
					<?php echo esc_html( bp_core_get_user_displayname( bp_get_activity_user_id() ) ); ?>
				</strong>
				<span class="middot">&middot;</span>
				<time>
					<?php echo esc_html( human_time_diff( bp_nouveau_get_activity_timestamp() ) ) . ' ago'; ?>
				</time>
			</div>
		</div>
	</a>
