			...
			<div class="media-folder_items ac-folder-list">
				...
				<div class="media-folder_modified">
					<div class="media-folder_details__bottom">
						...
						<span class="media-folder_author"><?php esc_html_e( 'by ', 'buddypress-search' ); ?><a href="<?php echo esc_url( trailingslashit( bp_core_get_user_domain( bp_get_document_folder_user_id() ) . bp_get_document_slug() ) ); ?>"><?php bp_folder_author(); ?></a></span>
					</div>
				</div>
					...
					<div class="media-folder_group">
						<div class="media-folder_details__bottom">
							...
							if ( $group_id > 0 ) {
								...
								<span class="media-folder_status"><?php echo esc_html( ucfirst( $group_status ) ); ?></span>
								<?php
							} else {
								?>
				...
				<div class="media-folder_visibility">
					<div class="media-folder_details__bottom">
						...
						if ( bp_is_active( 'groups' ) ) {
							...
							if ( $group_id > 0 ) {
								?>
								<span class="bp-tooltip" data-bp-tooltip-pos="down" data-bp-tooltip="<?php esc_attr_e( 'Based on group privacy', 'buddypress-search' ); ?>">
