<?php
/**
 * BuddyPress search bbPress forums replies.
 *
...
if ( ! class_exists( 'BuddyPress_Search_bbPress_Replies' ) ) :

	/**
	 * BuddyPress Global Search  - search bbpress forums replies class
	 */
	class BuddyPress_Search_bbPress_Replies extends BuddyPress_Search_bbPress {
		...
		public static function instance() {
			...
			if ( null === $instance ) {
				$instance = new BuddyPress_Search_bbPress_Replies();
			}
