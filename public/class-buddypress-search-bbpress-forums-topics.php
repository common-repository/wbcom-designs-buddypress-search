<?php
/**
 * BuddyPress search bbPress forums topics.
 *
...
if ( ! class_exists( 'BuddyPress_Search_bbPress_Topics' ) ) :

	/**
	 * BuddyPress Global Search  - search bbpress forums topics class
	 */
	class BuddyPress_Search_bbPress_Topics extends BuddyPress_Search_bbPress {
		...
		public function sql( $search_term, $only_totalrow_count = false ) {
			...
			$tax = array();
			if ( isset( $bpsearch_pages_posts_search[ $this->type ][ bbpress()->topic_tag_tax_id ] ) && $bpsearch_pages_posts_search[ $this->type ][ bbpress()->topic_tag_tax_id ] == 1 ) {
		...
		public static function instance() {
			...
			if ( null === $instance ) {
				$instance = new BuddyPress_Search_bbPress_Topics();
			}
